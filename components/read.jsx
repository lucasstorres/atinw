    ...
    {mostrar ?(
        <main className='container'>
          <div className='d-grid gap-2 col-6 mx-auto'>
            ...
            <input type="button" value="CANCELAR" className='form-control btn btn-outline-dark' onClick={bt_cancelar}/>
            <input type="submit" value="SALVAR" className='form-control btn btn-outline-dark' onClick={()=>bt_alterar(produtoUnico.id)}/>
          </div>
       </main>
    ):(
      <></>
